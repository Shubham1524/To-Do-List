...
export default function CreateToDo({ hide, create, task }) {
    ...
    return (
        <div className='flex flex-col gap-5 shadow-md rounded-xl p-5'>
            ...
            <input type="text" className='py-2 px-2 border-2 rounded-lg max-w-xs focus:border-yellow-400' placeholder='Write a task' onChange={handleValueChange} />
